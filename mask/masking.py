...
def create_mask(image_path):
    pic_path = image_path
    mask_path = "A:/PROJ fol/dataset/blue-mask.png" #mask image path
    show = False
    model = "hog"
    ##print("WOW")
    FaceMasker(pic_path, mask_path, show, model).mask()
        
#path of folder containing images to bbe masked
folder_path = "A:/PROJ fol/dataset/images/train/angry2"
